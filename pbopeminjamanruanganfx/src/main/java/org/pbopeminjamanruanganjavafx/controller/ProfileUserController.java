...
import org.pbopeminjamanruanganjavafx.dao.ProfileUserDAO;
...
public class ProfileUserController implements Initializable {
    ...
    private ProfileUserDAO profileDAO = new ProfileUserDAO();
   ...
   @Override
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if (userLoggedIn != null) {
            ...
            ProfileUser dataLengkap = profileDAO.getUserById(userLoggedIn.getIdUser());
            ...
            // NIM biasanya tidak boleh diedit karena Primary Key
    ...
    void btnSimpan(ActionEvent event) {
        try {
            ...
            ProfileUser updatedProfile = new ProfileUser(idUser, nama, username, email);
